...
const semesterRegistrationSchema = new Schema<TSemesterRegistration>({
    ...
    status: { type: String, enum: SemesterRegistrationsStatus, default: 'UPCOMING' },
...
export const SemesterRegistrations = model<TSemesterRegistration>('SemesterRegistration', semesterRegistrationSchema);